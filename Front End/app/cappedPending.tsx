...
export default function CappedPending() {
  ...
  const cleanupUser = async () => {
    try {
      const response = await fetch("https://migrated-backend.onrender.com/resetCappedStatus", {
        method: 'POST',
  ...
  const handleRefresh = async () => {
    try {
      const response = await fetch(`https://migrated-backend.onrender.com/fetchUserDataEmail/${user.email}`);
