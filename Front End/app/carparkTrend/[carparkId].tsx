...
export default function CarparkTrend() {
  ...
  useEffect(() => {
    const getCurrentTime = async () => {
      try {
        const response = await fetch("http://192.168.68.58:3000/getCurrentTime");
    ...
    const getForecast = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://192.168.68.58:3000/getAvailabilityForecast/${carparkId}`, {
          method: 'POST',
        });
  ...
  useEffect(() => {
    ...
    const getAvailabilityHistory = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://192.168.68.58:3000/fetchCarparkHistory/${carparkId}/${startTime / 1000}/${endTime / 1000}`);
